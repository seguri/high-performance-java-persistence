...
public class ForumService {
  ...
  public List<PostCommentDTO> findTopCommentHierarchiesByPostUsingJava(Long postId, int ranking) {
    ...
    Map<Long, PostCommentDTO> postCommentMap =
        postComments.stream().collect(Collectors.toMap(PostCommentDTO::getId, Function.identity()));
    ...
    List<PostCommentDTO> postCommentRoots =
        postComments.stream()
            ...
            .sorted(Comparator.comparing(PostCommentDTO::getTotalScore).reversed())
            .limit(ranking)
