...
public class SpringDataJPACustomRepositoryTest {
  ...
  public void testMultiplePosts() {
    ...
    List<Tag> tags =
        List.of(
            new Tag().setId(1L).setName("JDBC"),
            new Tag().setId(2L).setName("JPA"),
            new Tag().setId(3L).setName("Hibernate"));
    ...
    transactionTemplate.execute(
        (TransactionCallback<Void>)
            transactionStatus -> {
              ...
              List<String> postTitlesStreamRecords =
  ...
  public void testUpdate() {
    Post post = forumService.createPost(1L, "High-Performance Java Persistence");

    forumService.updatePostTitle(1L, "High-Performance Java Persistence 2nd edition");

    assertEquals(
        "High-Performance Java Persistence 2nd edition", forumService.findById(1L).getTitle());
  }
