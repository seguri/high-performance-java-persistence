...
public class SpringDataJPARecursiveTest {
  ...
  public void testAggregateUsingJava() {
    List<PostCommentDTO> postCommentRoots =
        forumService.findTopCommentHierarchiesByPostUsingJava(1L, TOP_N_HIERARCHY);
  ...
  public void testAggregateUsingSQL() {
    List<PostCommentDTO> postCommentRoots =
        forumService.findTopCommentHierarchiesByPostUsingSQL(1L, TOP_N_HIERARCHY);
