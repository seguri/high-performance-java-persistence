...
public class SpringDataJPAUnidirectionalEventListenerConfiguration
    extends SpringDataJPAUnidirectionalConfiguration {
  ...
  protected void additionalProperties(Properties properties) {
    ...
    properties.put(
        ...
        (IntegratorProvider) () -> List.of(CascadeDeleteEventListenerIntegrator.INSTANCE));
  }
}
