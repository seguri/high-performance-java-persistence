...
public class ProductService {
  ...
  public ProductService(
      @Autowired RestTemplate restTemplate, @Autowired ProductRepository productRepository) {
  ...
  private FxRate getFxRate() {
    ...
    if (fxRateXmlString != null) {
      fxRate = FxRateUtil.parseFxRate(fxRateXmlString.getBytes(StandardCharsets.UTF_8));
    }
