...
@EnableJpaRepositories(
    basePackages = {"com.vladmihalcea.hpjp.spring.transaction.readonly.repository"})
public class SpringDataJPAReadOnlyConfiguration extends SpringDataJPABaseConfiguration {
  ...
  protected void additionalProperties(Properties properties) {
    ...
    properties.setProperty(
        AvailableSettings.CONNECTION_PROVIDER_DISABLES_AUTOCOMMIT, Boolean.TRUE.toString());
    properties.setProperty(AvailableSettings.GENERATE_STATISTICS, Boolean.TRUE.toString());
    properties.setProperty(
        StatisticsInitiator.STATS_BUILDER, SpringTransactionStatisticsFactory.class.getName());
    properties.setProperty(
