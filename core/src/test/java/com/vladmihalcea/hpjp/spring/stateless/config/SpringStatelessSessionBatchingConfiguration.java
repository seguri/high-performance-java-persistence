...
@ComponentScan(
    value = {"com.vladmihalcea.hpjp.spring.stateless.service", "io.hypersistence.utils.spring.aop"})
public class SpringStatelessSessionBatchingConfiguration {
  ...
  @Bean
  public StatelessSessionBuilder statelessSessionBuilder(
  ...
  protected Properties additionalProperties() {
    ...
    properties.setProperty(
        AvailableSettings.HBM2DDL_AUTO, Action.NONE.name().toLowerCase(Locale.ROOT));
    properties.setProperty(
        AvailableSettings.STATEMENT_BATCH_SIZE, String.valueOf(batchProcessingSize()));
  ...
  protected String[] packagesToScan() {
    return new String[] {"com.vladmihalcea.hpjp.spring.stateless.domain"};
  }
}
