...
/**
 * This test case demonstrates what happens when you enable the AFTER_STATEMENT Hibernate connection
 * release mode when using a RESOURCE_LOCAL JPA transaction with Spring.
 *
 * <p>Currently, this mode is disabled, as it will make the test fail. To enable the AFTER_STATEMENT
 * release mode, open the {@link ResourceLocalReleaseAfterStatementConfiguration} file and pass the
 * {@code DELAYED_ACQUISITION_AND_RELEASE_AFTER_STATEMENT} setting to the {@code
 * CONNECTION_HANDLING} Hibernate configuration property.
 *
...
public class ResourceLocalReleaseAfterStatementTest {
  ...
  @Autowired private ReleaseAfterStatementForumService releaseAfterStatementForumService;

  @Test
  public void test() {
    Post newPost = releaseAfterStatementForumService.newPost("High-Performance Java Persistence");
    ...
    PostDTO postDTO =
        releaseAfterStatementForumService.savePostTitle(
