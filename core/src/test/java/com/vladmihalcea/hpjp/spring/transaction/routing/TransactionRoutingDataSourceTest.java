...
public class TransactionRoutingDataSourceTest {
  ...
  public void test() {
    Post post =
        forumService.newPost("High-Performance Java Persistence", "JDBC", "JPA", "Hibernate");

    List<Post> posts = forumService.findAllPostsByTitle("High-Performance Java Persistence");
  }
}
