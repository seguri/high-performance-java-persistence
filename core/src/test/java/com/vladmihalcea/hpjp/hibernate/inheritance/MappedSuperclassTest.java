...
public class MappedSuperclassTest extends AbstractTest {
    ...
    Topic topic =
        doInJPA(
            entityManager -> {
              ...
              entityManager.persist(new PostStatistics().setTopic(post).incrementViews());

              entityManager.persist(
                  new AnnouncementStatistics().setTopic(announcement).incrementViews());
  ...
  @MappedSuperclass
  public abstract static class Topic<T extends Topic<T>> {
