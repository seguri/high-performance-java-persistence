...
public class ConcurrentBatchIdentifierTest<T> extends AbstractTest {
  ...
  public ConcurrentBatchIdentifierTest(
      DataSourceProvider dataSourceProvider, PostEntityProvider entityProvider, int threadCount) {
  ...
  public void testIdentifierGenerator() throws InterruptedException, ExecutionException {
    LOGGER.debug(
        "testIdentifierGenerator, database: {}, entityProvider: {}, threadCount: {}",
