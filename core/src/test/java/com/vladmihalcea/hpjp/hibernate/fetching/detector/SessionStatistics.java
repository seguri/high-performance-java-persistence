...
public class SessionStatistics extends StatisticsImpl {
  ...
  private static final ThreadLocal<Map<Class, AtomicInteger>> entityFetchCountContext =
      new ThreadLocal<>();
  ...
  public void fetchEntity(String entityName) {
    ...
    entityFetchCountMap
        .computeIfAbsent(ReflectionUtils.getClass(entityName), clazz -> new AtomicInteger())
        .incrementAndGet();
  ...
  public static int getEntityFetchCount(String entityClassName) {
    return getEntityFetchCount(ReflectionUtils.getClass(entityClassName));
  }
