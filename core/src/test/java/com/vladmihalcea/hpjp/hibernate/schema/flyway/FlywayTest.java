...
public class FlywayTest {
  ...
  @Autowired private LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean;
  ...
  public void testValidate() {
    ...
    EntityManagerFactoryBuilder entityManagerFactoryBuilder =
        Bootstrap.getEntityManagerFactoryBuilder(
            localContainerEntityManagerFactoryBean.getPersistenceUnitInfo(), settings);
    ...
    final ExecutionOptions executionOptions =
        SchemaManagementToolCoordinator.buildExecutionOptions(
            settings, ExceptionHandlerHaltImpl.INSTANCE);
