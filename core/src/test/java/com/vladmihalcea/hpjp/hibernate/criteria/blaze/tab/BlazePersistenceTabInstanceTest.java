...
public class BlazePersistenceTabInstanceTest extends AbstractOracleIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      TabInstance.class, TabObject.class, TabSource.class, TabVersion.class, TabKeyVer.class
    };
  }
  ...
  private void insertData() {
    ...
    executeStatement(
        "INSERT INTO tab_instance VALUES (100, 3, 'O1 [R2.1] - R1/R2/C --> C', 'AD1', 1050)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (100, 4, 'O1 [R1.3] - R1/R2/C --> C', 'AD1', 1051)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (100, 5, 'O1 [C] - R1/R2/C --> C', 'AD2', 1050)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (200, 5, 'O2 [C] - R1/C --> C', 'AD4', 1250)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (200, 3, 'O2 [R2.1] - R1/C --> C', 'AD4', 1250)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (300, 4, 'O3 [R1.3] - R1/R2 --> R1', 'AD8', 1300)");
    executeStatement(
        "INSERT INTO tab_instance VALUES (300, 3, 'O3 [R2.1] - R1/R2 --> R1', 'AD9', 1301)");
  }
  ...
  public void testTwoLevelLeftJoinSubqueryWithGroupByQuery() {
    doInJPA(
        entityManager -> {
          ...
          List<TabInstance> tabInstances =
              cbf.create(entityManager, TabInstance.class)
                  ...
                  .bind("tabKey")
                  .select("ba.tabObject.tabKey")
                  .bind("tabVer")
                  .select("max(ba.id.tabVer)")
                  .innerJoin("ba.tabVersion", "va")
                  .innerJoin("va.tabSource", "da")
                  .where("da.tabAcronym")
                  .notEqExpression(":tabAcronym")
                  .where("ba.id.tabVer")
                  .in(tabVer)
  ...
  public void testLeftJoinWithGroupByQuery() {
    doInJPA(
        entityManager -> {
          ...
          List<TabObject> tabObjects =
              cbf.create(entityManager, TabObject.class)
                  .from(TabObject.class, "o")
                  .leftJoin("o.tabInstances", "bf")
                  .innerJoin("bf.tabVersion", "vf")
                  .innerJoinOn(TabSource.class, "df")
