...
/**
 * EntityOptimisticLockingHighUpdateRateSingleEntityTest - Test to check optimistic checking on a
 * single entity being updated by many threads
 *
...
public class OptimisticLockingOneRootEntityMultipleVersionsTest extends AbstractTest {
  ...
  @Test
  public void canConcurrentlyModifyEachOfSubEntities()
      throws InterruptedException, ExecutionException {
    executeOperations(new IncrementLikes(), new ModifyTitle("JPA"), new ModifyViews(15L));
  ...
  @Test
  public void optimisticLockingViolationForConcurrentViewsModifications()
      throws InterruptedException, ExecutionException {
    expectedException.expectCause(
        new ThrowableCauseMatcher<>(
            IsInstanceOf.<Throwable>instanceOf(OptimisticLockException.class)));
  ...
  @Test
  public void optimisticLockingViolationForConcurrentPostModifications()
      throws InterruptedException, ExecutionException {
    expectedException.expectCause(
        new ThrowableCauseMatcher<>(
            IsInstanceOf.<Throwable>instanceOf(OptimisticLockException.class)));
  ...
  @Test
  public void optimisticLockingViolationForConcurrentLikeModifications()
      throws InterruptedException, ExecutionException {
    expectedException.expectCause(
        new ThrowableCauseMatcher<>(
            IsInstanceOf.<Throwable>instanceOf(OptimisticLockException.class)));
    ...
    executeOperations(
        new IncrementLikes(), new IncrementLikes(), new ModifyTitle("JPA"), new ModifyViews(2L));
  }

  private void executeOperations(DoWithPost... operations)
      throws InterruptedException, ExecutionException {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Post.class, PostViews.class, PostLikes.class};
  }
  ...
  public static class PostViews {
    ...
    @MapsId @OneToOne private Post post;
