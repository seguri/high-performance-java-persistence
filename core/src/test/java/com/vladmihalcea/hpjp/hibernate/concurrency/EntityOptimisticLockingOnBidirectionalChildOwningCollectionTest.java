...
/**
 * EntityOptimisticLockingOnBidirectionalChildOwningCollectionTest - Test to check optimistic
 * locking on bidirectional child owning collections
 *
...
public class EntityOptimisticLockingOnBidirectionalChildOwningCollectionTest
    extends AbstractEntityOptimisticLockingCollectionTest<
        EntityOptimisticLockingOnBidirectionalChildOwningCollectionTest.Post,
        EntityOptimisticLockingOnBidirectionalChildOwningCollectionTest.Comment> {
