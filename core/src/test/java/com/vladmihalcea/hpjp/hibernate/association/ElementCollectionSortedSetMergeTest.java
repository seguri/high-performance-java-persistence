...
public class ElementCollectionSortedSetMergeTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Post.class, PostCategory.class};
  }
  ...
  protected void afterInit() {
    doInJPA(
        entityManager -> {
          PostCategory category1 = new PostCategory().setCategory("Post");
          PostCategory category2 = new PostCategory().setCategory("Archive");
  ...
  private PostDTO getPostDTO() {
    ...
    postDTO
        ...
        .addComment(
            new Comment().setComment("A must-read for every Java developer!").setAuthor("Bob"))
  ...
  public static class Comment implements Serializable, Comparable {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(comment, comment1.comment) && Objects.equals(author, comment1.author);
    }
  ...
  public static class Tag implements Serializable {
    ...
    public boolean equals(Object o) {
      ...
      Tag tag = (Tag) o;
      return Objects.equals(name, tag.name) && Objects.equals(author, tag.author);
    }
  ...
  public static class CommentComparator
      implements Comparator<ElementCollectionSortedSetMergeTest.Comment> {
    @Override
    public int compare(
        ElementCollectionSortedSetMergeTest.Comment o1,
        ElementCollectionSortedSetMergeTest.Comment o2) {
      return 0;
    }
  }
}
