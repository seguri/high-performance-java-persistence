...
public class LatestChildJoinFormulaTest extends AbstractPostgreSQLIntegrationTest {
  ...
  public void test() {
        ...
        entityManager -> {
          ...
          entityManager.persist(
              new PostComment()
                  .setId(1L)
                  .setPost(post)
                  .setCreatedOn(Timestamp.valueOf(LocalDateTime.of(2016, 11, 2, 12, 33, 14)))
                  .setReview("Woohoo!"));
          ...
          entityManager.persist(
              new PostComment()
                  .setId(2L)
                  .setPost(post)
                  .setCreatedOn(Timestamp.valueOf(LocalDateTime.of(2016, 11, 2, 15, 45, 58)))
                  .setReview("Finally!"));
          ...
          entityManager.persist(
              new PostComment()
                  .setId(3L)
                  .setPost(post)
                  .setCreatedOn(Timestamp.valueOf(LocalDateTime.of(2017, 2, 16, 16, 10, 21)))
                  .setReview("Awesome!"));
        });
    ...
    doInJPA(
        entityManager -> {
          entityManager.persist(
              new Post().setId(2L).setTitle("High-Performance Java Persistence 2nd edition"));
        });
