    ...
    try {
      doInJPA(
          entityManager -> {
                      ...
                      doInJPA(
                          _entityManager -> {
                            ...
                            PostComment _comment =
                                _entityManager.find(
                                    PostComment.class, 1L, LockModeType.PESSIMISTIC_WRITE);
                            bobStart.countDown();
                            LOGGER.info("Bob wants to lock the Post entity");
                            Post _post =
                                _entityManager.find(Post.class, 1L, LockModeType.PESSIMISTIC_WRITE);
                          });
                    });
            ...
            PostComment comment =
                entityManager.find(PostComment.class, 1L, LockModeType.PESSIMISTIC_WRITE);
