...
public class WithRecursiveCTEFetchingTest extends AbstractMySQLIntegrationTest {
   ...
   * <p>post_comment -------------
   *
   * <p>| id | created_on | review | score | parent_id | post_id |
   * |----|---------------------|---------------|-------|-----------|---------| | 1 | 2019-10-13
   * 12:23:05 | Comment 1 | 1 | | 1 | | 2 | 2019-10-14 13:23:10 | Comment 1.1 | 2 | 1 | 1 | | 3 |
   * 2019-10-14 15:45:15 | Comment 1.2 | 2 | 1 | 1 | | 4 | 2019-10-15 10:15:20 | Comment 1.2.1 | 1 |
   * 3 | 1 | | 5 | 2019-10-13 15:23:25 | Comment 2 | 1 | | 1 | | 6 | 2019-10-14 11:23:30 | Comment
   * 2.1 | 1 | 5 | 1 | | 7 | 2019-10-14 14:45:35 | Comment 2.2 | 1 | 5 | 1 | | 8 | 2019-10-15
   * 10:15:40 | Comment 3 | 1 | | 1 | | 9 | 2019-10-16 11:15:45 | Comment 3.1 | 10 | 8 | 1 | | 10 |
   * 2019-10-17 18:30:50 | Comment 3.2 | -2 | 8 | 1 | | 11 | 2019-10-19 21:43:55 | Comment 4 | -5 |
   * | 1 | | 12 | 2019-10-22 23:45:00 | Comment 5 | 0 | | 1 |
   */
  @Override
  public void afterInit() {
    doInJPA(
        entityManager -> {
          Post post = new Post().setId(1L).setTitle("Post 1");
   ...
   *
   * <p>This implementation allows the database to calculate the comment hierarchy score, so we can
   * fetch just the top comment hierarchies.
   *
   * <p>This SQL query combines a WITH RECURSIVE query with several Derives Table subsequent
   * queries.
   *
   * <p>SELECT id, parent_id, review, created_on, score, total_score FROM ( SELECT id, parent_id,
   * review, created_on, score, total_score, DENSE_RANK() OVER (ORDER BY total_score DESC) AS
   * ranking FROM ( SELECT id, parent_id, review, created_on, score, SUM(score) OVER (PARTITION BY
   * root_id) AS total_score FROM ( WITH RECURSIVE post_comment_score( id, root_id, post_id,
   * parent_id, review, created_on, score) AS ( SELECT id, id, post_id, parent_id, review,
   * created_on, score FROM post_comment WHERE post_id = 1 AND parent_id IS NULL UNION ALL SELECT
   * pc.id, pcs.root_id, pc.post_id, pc.parent_id, pc.review, pc.created_on, pc.score FROM
   * post_comment pc INNER JOIN post_comment_score pcs ON pc.parent_id = pcs.id ) SELECT id,
   * parent_id, root_id, review, created_on, score FROM post_comment_score ) total_score_comment )
   * total_score_ranking ) total_score_filtering WHERE ranking <= 3 ORDER BY total_score DESC, id
   * ASC
   *
   * <p>| id | parent_id | review | created_on | score | total_score |
   * |----|-----------|---------------|---------------------|-------|-------------| | 8 | | Comment
   * 3 | 2019-10-15 10:15:40 | 1 | 9 | | 9 | 8 | Comment 3.1 | 2019-10-16 11:15:45 | 10 | 9 | | 10 |
   * 8 | Comment 3.2 | 2019-10-17 18:30:50 | -2 | 9 | | 1 | | Comment 1 | 2019-10-13 12:23:05 | 1 |
   * 6 | | 2 | 1 | Comment 1.1 | 2019-10-14 13:23:10 | 2 | 6 | | 3 | 1 | Comment 1.2 | 2019-10-14
   * 15:45:15 | 2 | 6 | | 4 | 3 | Comment 1.2.1 | 2019-10-15 10:15:20 | 1 | 6 | | 5 | | Comment 2 |
   * 2019-10-13 15:23:25 | 1 | 3 | | 6 | 5 | Comment 2.1 | 2019-10-14 11:23:30 | 1 | 3 | | 7 | 5 |
   * Comment 2.2 | 2019-10-14 14:45:35 | 1 | 3 |
   */
  @Test
  public void testFetchAndSortUsingRecursiveCTEAndDerivedTables() {
    ...
    doInJPA(
        entityManager -> {
          ...
          List<PostCommentScore> postCommentRoots =
              entityManager
                  .createNativeQuery(
  ...
  public static class PostCommentScore {
    ...
    public PostCommentScore(
        Number id, Number parentId, String review, Date createdOn, Number score) {
