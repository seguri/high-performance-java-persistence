...
public class EagerFetchingDetectorTest extends AbstractTest {
  ...
  protected void additionalProperties(Properties properties) {
    ...
    properties.put(StatisticsInitiator.STATS_BUILDER, SessionStatistics.Factory.INSTANCE);
  }
  ...
  public void testJPQLPostCommentDetails() {
    doInJPA(
        entityManager -> {
          ...
          List<PostCommentDetails> commentDetailsList =
              entityManager
                  .createQuery(
                      """
                select pcd
          ...
          for (PostCommentDetails commentDetails : commentDetailsList) {
            assertTrue(
                associationFetchMap.get(PostComment.class).contains(commentDetails.getComment()));
            assertTrue(
                associationFetchMap
                    .get(Post.class)
