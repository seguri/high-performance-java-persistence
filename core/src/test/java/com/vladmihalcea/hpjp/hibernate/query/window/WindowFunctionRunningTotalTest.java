...
public class WindowFunctionRunningTotalTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      Account.class, AccountTransaction.class,
    };
  }
   ...
   * account -------
   *
   * <p>| id | iban | owner | |----|-----------------|-------------| | 1 | 123-456-789-010 | Alice
   * Smith | | 2 | 123-456-789-101 | Bob Johnson |
   *
   * <p>account_transaction -------------------
   *
   * <p>| id | amount | created_on | account_id | |----|--------|---------------------|------------|
   * | 1 | 2560 | 2019-10-13 12:23:00 | 1 | | 2 | -200 | 2019-10-14 13:23:00 | 1 | | 3 | 500 |
   * 2019-10-14 15:45:00 | 1 | | 4 | -1850 | 2019-10-15 10:15:00 | 1 | | 5 | 2560 | 2019-10-13
   * 15:23:00 | 2 | | 6 | 300 | 2019-10-14 11:23:00 | 2 | | 7 | -500 | 2019-10-14 14:45:00 | 2 | | 8
   * | -150 | 2019-10-15 10:15:00 | 2 |
   */
  @Override
  public void afterInit() {
    doInJPA(
        entityManager -> {
          Account account1 =
              new Account().setId(1L).setOwner("Alice Smith").setIban("123-456-789-010");

          Account account2 =
              new Account().setId(2L).setOwner("Bob Johnson").setIban("123-456-789-101");
   ...
   *
   * <p>SELECT ROW_NUMBER() OVER( PARTITION BY account_id ORDER BY created_on, id ) AS nr, id,
   * account_id, created_on, amount, SUM(amount) OVER( PARTITION BY account_id ORDER BY created_on,
   * id ) AS balance FROM account_transaction ORDER BY id
   *
   * <p>| nr | id | account_id | created_on | amount | balance |
   * |----|----|------------|----------------------------|--------|---------| | 1 | 1 | 1 |
   * 2019-10-13 12:23:00.000000 | 2560 | 2560 | | 2 | 2 | 1 | 2019-10-14 13:23:00.000000 | -200 |
   * 2360 | | 3 | 3 | 1 | 2019-10-14 15:45:00.000000 | 500 | 2860 | | 4 | 4 | 1 | 2019-10-15
   * 10:15:00.000000 | -1850 | 1010 | | 1 | 5 | 2 | 2019-10-13 15:23:00.000000 | 2560 | 2560 | | 2 |
   * 6 | 2 | 2019-10-14 11:23:00.000000 | 300 | 2860 | | 3 | 7 | 2 | 2019-10-14 14:45:00.000000 |
   * -500 | 2360 | | 4 | 8 | 2 | 2019-10-15 10:15:00.000000 | -150 | 2210 |
   */
  @Test
  public void testSQL() {
    doInJPA(
        entityManager -> {
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 13, 12, 23, 0)),
              tuple1.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 14, 13, 23, 0)),
              tuple2.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 14, 15, 45, 0)),
              tuple3.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 15, 10, 15, 0)),
              tuple4.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 13, 15, 23, 0)),
              tuple5.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 14, 11, 23, 0)),
              tuple6.get("created_on"));
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2019, 10, 14, 14, 45, 0)),
              tuple7.get("created_on"));
  ...
  public static record StatementRecord(Long nr, AccountTransaction transaction, Long balance) {}
