  ...
  public void test() {
        ...
        entityManager -> {
          UserAccount user =
              new UserAccount()
                  ...
                  .setSubscribedOn(parseDate("2013-09-29"));
          ...
          Post post =
              new Post()
                  ...
                  .setCreatedBy(user)
                  .setPublishedOn(parseTimestamp("2020-05-01 12:30:00"));
    ...
    doInJPA(
        entityManager -> {
          ...
          assertEquals(parseTimestamp("2020-05-01 12:30:00"), post.getPublishedOn());

          UserAccount userAccount = post.getCreatedBy();

          assertEquals(parseDate("2013-09-29"), userAccount.getSubscribedOn());
        });
  }
