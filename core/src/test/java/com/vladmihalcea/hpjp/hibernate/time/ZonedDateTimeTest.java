...
public class ZonedDateTimeTest extends AbstractMySQLIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Post.class, UserAccount.class};
  }
  ...
  public void test() {
        ...
        entityManager -> {
          UserAccount user =
              new UserAccount()
                  ...
                  .setSubscribedOn(LocalDate.of(2013, 9, 29));
          ...
          Post post =
              new Post()
                  ...
                  .setCreatedBy(user)
                  .setPublishedOn(
                      LocalDateTime.of(2020, 5, 1, 12, 30, 0).atZone(ZoneId.systemDefault()));
    ...
    doInJPA(
        entityManager -> {
          ...
          assertEquals(
              LocalDateTime.of(2020, 5, 1, 12, 30, 0).atZone(ZoneId.systemDefault()).toInstant(),
              post.getPublishedOn().toInstant());

          UserAccount userAccount = post.getCreatedBy();

          assertEquals(LocalDate.of(2013, 9, 29), userAccount.getSubscribedOn());
        });
  }
