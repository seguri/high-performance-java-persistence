...
public class OptimisticLockingContractTest extends AbstractTest {
  ...
  public static class RootAwareEventListenerIntegrator implements Integrator {
    ...
    public void integrate(
      ...
      eventListenerRegistry.appendListeners(
          EventType.PERSIST, RootAwareInsertEventListener.INSTANCE);
      eventListenerRegistry.appendListeners(
          EventType.FLUSH_ENTITY, RootAwareUpdateAndDeleteEventListener.INSTANCE);
    }
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      Contract.class, Annex.class, Signature.class,
    };
  }
  ...
  public void test() {
    doInJPA(
        entityManager -> {
          Contract contract = new Contract().setId(1L).setTitle("Hypersistence Training");
          ...
          Signature signature1 = new Signature().setAnnex(annex1).setUserName("Vlad Mihalcea");
          ...
          Signature signature2 = new Signature().setAnnex(annex2).setUserName("Vlad Mihalcea");
    ...
    doInJPA(
        entityManager -> {
          ...
          Annex annex =
              new Annex().setId(3L).setDetails("Spring 6 Migration Training").setContract(contract);
