...
public class MySQLJsonRecordTest extends AbstractMySQLIntegrationTest {
  ...
  public void testFetchAndUpdate() {
    ...
    doInJPA(
        entityManager -> {
          ...
          assertEquals("High-Performance Java Persistence", bookRecord.title());
          assertEquals("Vlad Mihalcea", bookRecord.author());
  ...
  public static record BookRecord(
      String title, String author, String publisher, Long priceInCents, URL url)
    ...
    public BookRecord(
      ...
      this(title, author, publisher, longValue(priceInCents), urlValue(url));
    }
  }
}
