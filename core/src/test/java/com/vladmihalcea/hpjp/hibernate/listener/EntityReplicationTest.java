  ...
  public static class ReplicationEventListenerIntegrator implements Integrator {
    ...
    public void integrate(
      ...
      eventListenerRegistry.appendListeners(
          EventType.POST_INSERT, ReplicationInsertEventListener.INSTANCE);
      eventListenerRegistry.appendListeners(
          EventType.POST_UPDATE, ReplicationUpdateEventListener.INSTANCE);
      eventListenerRegistry.appendListeners(
          EventType.PRE_DELETE, ReplicationDeleteEventListener.INSTANCE);
    }
    ...
    public void onPostInsert(PostInsertEvent event) throws HibernateException {
      ...
      if (entity instanceof Post) {
        ...
        event
            .getSession()
            .createNativeQuery(
                "INSERT INTO old_post (id, title, version) " + "VALUES (:id, :title, :version)")
    ...
    public void onPostUpdate(PostUpdateEvent event) {
      ...
      if (entity instanceof Post) {
        ...
        event
            .getSession()
            .createNativeQuery(
                "UPDATE old_post " + "SET title = :title, version = :version " + "WHERE id = :id")
            .setParameter("id", post.getId())
            .setParameter("title", post.getTitle())
            .setParameter("version", post.getVersion())
            .setHibernateFlushMode(FlushMode.MANUAL)
  ...
  public static class ReplicationDeleteEventListener implements PreDeleteEventListener {
    ...
    public boolean onPreDelete(PreDeleteEvent event) {
      ...
      if (entity instanceof Post) {
        ...
        event
            .getSession()
            .createNativeQuery("DELETE FROM old_post " + "WHERE id = :id")
            .setParameter("id", post.getId())
            .setHibernateFlushMode(FlushMode.MANUAL)
            .executeUpdate();
      }
