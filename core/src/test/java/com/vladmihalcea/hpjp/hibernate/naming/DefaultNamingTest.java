...
public class DefaultNamingTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      PersonAddress.class, PersonLocation.class, Person.class,
    };
  }
  ...
  public void test() {
    ...
    doInJPA(
        entityManager -> {
          ...
          assertEquals(
              Long.valueOf(1L), person.addressIsAVeryLongColumnThatExceedsThirtyCharacters.id);
  ...
  public static class Person {
    ...
    @ManyToOne private PersonAddress addressIsAVeryLongColumnThatExceedsThirtyCharacters;

    @ManyToOne private PersonLocation location;
  }
}
