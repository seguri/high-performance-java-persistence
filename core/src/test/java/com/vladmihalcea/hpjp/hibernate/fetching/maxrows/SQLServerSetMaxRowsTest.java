        ...
        entityManager -> {
          ...
          entityManager
              ...
              .doWork(
                  connection -> {
                    try (Statement statement = connection.createStatement()) {
                      statement.executeUpdate("SET STATISTICS IO, TIME, PROFILE ON");

                      statement.setMaxRows(50);
                      boolean moreResultSets =
                          statement.execute(
                              """
                            SELECT p.title
                            FROM post p
                      ...
                      statement.executeUpdate("SET STATISTICS IO, TIME, PROFILE OFF");
                    }
                  });
