          ...
          for (int i = 0; i < entityCount; i++) {
            Post post =
                new Post()
                    ...
                    .addComment(new PostComment().setId(i * 10L).setReview("Good"))
                    .addComment(new PostComment().setId(i * 10L + 1).setReview("Excellent"));

            Tag tag1 = new Tag().setId(i * 10L).setName("Java");

            Tag tag2 = new Tag().setId(i * 10L + 1).setName("Hibernate");
