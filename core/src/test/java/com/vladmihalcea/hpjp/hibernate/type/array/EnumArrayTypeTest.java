...
public class EnumArrayTypeTest extends AbstractPostgreSQLIntegrationTest {
  ...
  protected void beforeInit() {
    ...
    executeStatement(
        "CREATE TYPE sudoku_state AS ENUM ('POSSIBLE', 'IMPOSSIBLE', 'UNDEFINED', 'UNKNOWN')");
  }
  ...
  public void test() {
    doInJPA(
        entityManager -> {
          ...
          sudoku.setStateValues(
              new SudokuPossibleValueState[] {
  ...
  public static class Sudoku extends BaseEntity {
    ...
    @Type(
        ...
        parameters =
            @org.hibernate.annotations.Parameter(name = "sql_array_type", value = "sudoku_state"))
