...
public class UnionIntersectExceptTest extends AbstractTest {
  ...
  private List<String> categories = List.of("Java", "JPA", "jOOQ", "Spring");

  private List<String> tags = List.of("Hibernate", "JDBC", "JPA", "jOOQ", "Spring");
  ...
  public void testExcept() {
    ...
    List<String> topics =
        categories.stream().filter(Predicate.not(tags::contains)).distinct().toList();
