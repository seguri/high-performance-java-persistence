...
public class EagerFetchingManyToOneEntityGraphTest extends AbstractPostgreSQLIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Post.class, PostComment.class, PostDetails.class};
  }
          ...
          for (long i = 1; i <= 3; i++) {
            entityManager.persist(
                new Post()
                    ...
                    .addComment(new PostComment().setReview("The first part is about JDBC"))
                    .addComment(new PostComment().setReview("The second part is about JPA"))
                    .addComment(new PostComment().setReview("The third part is about jOOQ")));
          }
        });
  }
