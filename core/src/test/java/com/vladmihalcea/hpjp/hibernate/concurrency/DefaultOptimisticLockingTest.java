...
public class DefaultOptimisticLockingTest extends AbstractTest {
  ...
  public void testOptimisticLockExceptionUpdate() {
    ...
    try {
      ...
      assertTrue(
          StaleStateException.class.isAssignableFrom(expected.getCause().getCause().getClass()));
    }
  }
  ...
  public void testOptimisticLockExceptionMerge() {
    ...
    try {
      ...
      assertTrue(
          StaleStateException.class.isAssignableFrom(ExceptionUtil.rootCause(expected).getClass()));
    }
  }
