...
public class OptimisticLockingAggregateRootVersionTest extends AbstractTest {
  ...
  public static class RootAwareEventListenerIntegrator
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      Post.class, PostComment.class, PostCommentDetails.class,
    };
  }
  ...
  public void test() {
    ...
    doInJPA(
        entityManager -> {
          Post post = entityManager.getReference(Post.class, 1L);
          entityManager
              .createQuery("delete from PostComment p where p.post.id = :postId")
