        ...
        entityManager -> {
          entityManager.persist(
              new Post()
                  ...
                  .addComment(
                      new PostComment().setId(2L).setReview("The best JPA ORM book out there"))
                  .addComment(
                      new PostComment().setId(3L).setReview("Must-read for Java developers")));
        });
    ...
    doInJPA(
        entityManager -> {
          ...
          for (PostComment comment : post.getComments()) {
            LOGGER.info("{} book review: {}", post.getTitle(), comment.getReview());
          }
        });
