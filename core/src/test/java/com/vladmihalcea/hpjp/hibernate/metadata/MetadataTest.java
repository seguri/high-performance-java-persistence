...
public class MetadataTest extends AbstractMySQLIntegrationTest {
        ...
        LOGGER.info(
            ...
            StreamSupport.stream(
                    Spliterators.spliteratorUnknownSize(
                        table.getColumnIterator(), Spliterator.ORDERED),
                    false)
  ...
  public void testEntityToDatabaseBindingMetadata() {
    ...
    for (PersistentClass persistentClass : metadata.getEntityBindings()) {
      ...
      LOGGER.info(
          "Entity: {} is mapped to table: {}", persistentClass.getClassName(), table.getName());
      ...
      for (Iterator propertyIterator = persistentClass.getPropertyIterator();
        ...
        for (Iterator columnIterator = property.getColumnIterator(); columnIterator.hasNext(); ) {
          ...
          LOGGER.info(
              "Property: {} is mapped on table column: {} of type: {}",
              property.getName(),
              column.getName(),
              column.getSqlType());
        }
