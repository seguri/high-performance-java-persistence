...
public class RunningTotalTest extends AbstractPostgreSQLIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      Animal.class, Stable.class, AnimalStable.class,
    };
  }
  ...
  public void test() {
    ...
    doInJPA(
        entityManager -> {
          ...
          animalStable1.registeredOn =
              Date.from(LocalDate.of(2017, 1, 10).atStartOfDay().toInstant(ZoneOffset.UTC));
          ...
          animalStable2.registeredOn =
              Date.from(LocalDate.of(2017, 1, 11).atStartOfDay().toInstant(ZoneOffset.UTC));
          ...
          animalStable4.registeredOn =
              Date.from(LocalDate.of(2017, 1, 12).atStartOfDay().toInstant(ZoneOffset.UTC));
          ...
          animalStable5.registeredOn =
              Date.from(LocalDate.of(2017, 1, 13).atStartOfDay().toInstant(ZoneOffset.UTC));
          ...
          animalStable6.registeredOn =
              Date.from(LocalDate.of(2017, 1, 14).atStartOfDay().toInstant(ZoneOffset.UTC));
