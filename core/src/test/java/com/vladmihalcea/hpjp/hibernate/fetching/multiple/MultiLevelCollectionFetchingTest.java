...
public class MultiLevelCollectionFetchingTest extends AbstractPostgreSQLIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Post.class, PostComment.class, Tag.class, User.class, UserVote.class};
  }
        ...
        entityManager -> {
          ...
          for (long postId = 1; postId <= POST_COUNT; postId++) {
            ...
            for (long i = 0; i < POST_COMMENT_COUNT; i++) {
              PostComment comment = new PostComment().setId(++commentId).setReview("Excellent!");
