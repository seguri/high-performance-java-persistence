...
/**
 * AbstractEntityOptimisticLockingCollectionTest - Abstract Test to check optimistic locking
 * collection versioning
 *
 * @author Vlad Mihalcea
 */
public abstract class AbstractEntityOptimisticLockingCollectionTest<
        P extends AbstractEntityOptimisticLockingCollectionTest.IPost<C>,
        C extends AbstractEntityOptimisticLockingCollectionTest.IComment<P>>
  ...
  protected AbstractEntityOptimisticLockingCollectionTest(
      Class<P> postClass, Class<C> commentClass) {
