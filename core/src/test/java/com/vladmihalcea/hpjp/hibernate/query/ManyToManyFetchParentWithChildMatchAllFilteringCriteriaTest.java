...
public class ManyToManyFetchParentWithChildMatchAllFilteringCriteriaTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {Cluster.class, Tag.class, ClusterTag.class};
  }
  ...
  public static class ClusterTag {
    ...
    @EmbeddedId private ClusterTagId id;
  ...
  @Table(
      name = "tag",
      uniqueConstraints = @UniqueConstraint(columnNames = {"tag_name", "tag_value"}))
