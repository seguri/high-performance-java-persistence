...
/**
 * EntityOptimisticLockingOnUnidirectionalCollectionTest - Test to check optimistic locking on
 * unidirectional collections
 *
...
public class EntityOptimisticLockingOnUnidirectionalCollectionTest
    extends AbstractEntityOptimisticLockingCollectionTest<
        EntityOptimisticLockingOnUnidirectionalCollectionTest.Post,
        EntityOptimisticLockingOnUnidirectionalCollectionTest.Comment> {
