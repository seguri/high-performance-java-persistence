...
public class AssociationFetch {
  ...
  public static class Context implements Serializable {
    ...
    public Map<Class, List<Object>> getAssociationFetchEntityMap() {
      return getAssociationFetches().stream()
    ...
    public void preLoad(LoadEvent loadEvent) {
      ...
      entityFetchCountByClassNameMap.put(
          entityClassName, SessionStatistics.getEntityFetchCount(entityClassName));
    }
    ...
    public void load(LoadEvent loadEvent) {
      ...
      EntityIdentifier entityIdentifier =
          new EntityIdentifier(
              ReflectionUtils.getClass(loadEvent.getEntityClassName()), loadEvent.getEntityId());
    ...
    public void postLoad(PostLoadEvent postLoadEvent) {
      loadedEntities.put(
          new EntityIdentifier(postLoadEvent.getEntity().getClass(), postLoadEvent.getId()),
