...
public class PostCommentScoreTest extends AbstractPostgreSQLIntegrationTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {
      Post.class, PostComment.class, User.class, PostCommentVote.class,
    };
  }
  ...
  protected List<PostCommentScore> postCommentScoresInMemory(Long postId, int rank) {
    return doInJPA(
        entityManager -> {
          ...
          Map<Long, List<PostCommentScore>> postCommentScoreMap =
              postCommentScores.stream().collect(Collectors.groupingBy(PostCommentScore::getId));
  ...
  public static class PostComment {
    ...
    public String toString() {
      return "PostComment{" + "review='" + review + '\'' + ", post=" + post + '}';
    }
  }
  ...
  public static class PostCommentVote implements Serializable {
    ...
    @Id @ManyToOne private PostComment comment;
    ...
    @Override
    public String toString() {
      return "PostCommentVote{" + "user=" + user + ", comment=" + comment + '}';
    }
  }
}
