...
public class JPADTOProjectionTest extends AbstractTest {
        ...
        (IntegratorProvider)
            () ->
                Collections.singletonList(
                    new ClassImportIntegrator(List.of(PostDTO.class, PostRecord.class))));
  }
  ...
  public void testNamedQuery() {
    doInJPA(
        entityManager -> {
          List<PostDTO> postDTOs =
              entityManager.createNamedQuery("PostDTOEntityQuery", PostDTO.class).getResultList();
  ...
  public void testNamedNativeQuery() {
    doInJPA(
        entityManager -> {
          List<PostDTO> postDTOs =
              entityManager.createNamedQuery("PostDTONativeQuery").getResultList();
  ...
  public static record PostRecord(Number id, String title) {}
}
