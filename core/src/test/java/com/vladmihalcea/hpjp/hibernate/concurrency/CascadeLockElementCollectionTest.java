...
public class CascadeLockElementCollectionTest extends AbstractTest {
  ...
  @Test
  public void testCascadeLockOnManagedEntityWithAssociationsInitialzied()
  ...
  @Test
  public void testCascadeLockOnManagedEntityWithAssociationsInitializedAndJpa()
      throws InterruptedException {
    LOGGER.info("Test lock cascade for managed entity");
    doInJPA(
        entityManager -> {
          Post post =
              entityManager
                  .createQuery(
                      "select p " + "from Post p " + "join fetch p.details " + "where p.id = :id",
                      Post.class)
                  .setParameter("id", 1L)
                  .getSingleResult();
          entityManager.lock(
  ...
  @Test
  public void testCascadeLockOnManagedEntityWithAssociationsUninitializedAndJpa()
      throws InterruptedException {
    LOGGER.info("Test lock cascade for managed entity");
    doInJPA(
        entityManager -> {
  ...
  public static class Post {
    ...
    @ElementCollection private List<PostComment> comments = new ArrayList<>();
