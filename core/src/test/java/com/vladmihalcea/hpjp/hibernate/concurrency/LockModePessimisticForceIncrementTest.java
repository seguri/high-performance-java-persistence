...
public class LockModePessimisticForceIncrementTest extends AbstractTest {
    ...
    doInJPA(
        entityManager -> {
          Repository repository =
              entityManager.find(Repository.class, 1L, LockModeType.PESSIMISTIC_FORCE_INCREMENT);
  ...
  @Test
  public void testConcurrentPessimisticForceIncrementLockingWithLockWaiting()
                  ...
                  doInJPA(
                      _entityManager -> {
                        ...
                        Repository _repository =
                            _entityManager.find(
                                Repository.class, 1L, LockModeType.PESSIMISTIC_FORCE_INCREMENT);
