...
/**
 * OptimisticLockingOneRootDirtyVersioningTest - Test to check optimistic checking on a single
 * entity being updated by many threads using the dirty properties instead of a synthetic version
 * column
 *
