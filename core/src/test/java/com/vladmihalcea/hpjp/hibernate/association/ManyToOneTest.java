...
public class ManyToOneTest extends AbstractTest {
  ...
  public void testLifecycle() {
    doInJPA(
        entityManager -> {
          Post post = new Post().setId(1L).setTitle("First post");
    ...
    doInJPA(
        entityManager -> {
          ...
          entityManager.persist(
              new PostComment().setId(1L).setReview("My first review").setPost(post));
        });
  ...
  public void testThreePostComments() {
    ...
    doInJPA(
        entityManager -> {
          ...
          entityManager.persist(
              new PostComment().setId(2L).setReview("My second review").setPost(post));

          entityManager.persist(
              new PostComment().setId(3L).setReview("My third review").setPost(post));
        });
  ...
  public void testPersistWithFind() {
    ...
    doInJPA(
        entityManager -> {
          ...
          entityManager.persist(
              new PostComment().setId(1L).setReview("Amazing book!").setPost(post));
        });
  }
