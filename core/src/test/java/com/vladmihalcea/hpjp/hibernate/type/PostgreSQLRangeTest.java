  ...
  public void test() {
    doInJPA(
        entityManager -> {
          ...
          book.setPriceRange(Range.closed(BigDecimal.valueOf(39.95d), BigDecimal.valueOf(45.95d)));
          book.setDiscountDateRange(
              Range.closedOpen(LocalDate.of(2019, 11, 29), LocalDate.of(2019, 12, 3)));
    ...
    doInJPA(
        entityManager -> {
          ...
          assertTrue(
              discountedBooks.stream()
                  .anyMatch(book -> book.getTitle().equals("High-Performance Java Persistence")));
        });
  }
