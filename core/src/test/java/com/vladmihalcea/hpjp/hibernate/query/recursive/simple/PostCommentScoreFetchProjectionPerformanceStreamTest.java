 ...
 */
public class PostCommentScoreFetchProjectionPerformanceStreamTest
    extends AbstractPostCommentScorePerformanceTest {

  protected com.codahale.metrics.Timer inMemoryProcessingTimer =
      metricRegistry.timer("In-memory processing timer");
    ...
    List<PostCommentScore> roots =
        doInJPA(
            entityManager -> {
              ...
              Map<Long, PostCommentScore> postCommentScoreMap =
                  postCommentScores.stream()
              ...
              List<PostCommentScore> postCommentRoots =
                  postCommentScores.stream()
                      ...
                      .sorted(Comparator.comparing(PostCommentScore::getTotalScore).reversed())
                      .limit(rank)
                      .collect(Collectors.toList());

              return postCommentRoots;
            });
    inMemoryProcessingTimer.update(
        System.nanoTime() - startInMemoryProcessingNanos.get(), TimeUnit.NANOSECONDS);
