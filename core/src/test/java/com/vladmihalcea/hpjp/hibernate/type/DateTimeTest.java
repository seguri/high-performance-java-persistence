  ...
  public void testOffsetDateTimeEvent() {
    ...
    doInJPA(
        entityManager -> {
          ...
          try {
            assertEquals(
                OffsetDateTime.of(2017, 1, 1, 0, 0, 0, 0, ZoneOffset.UTC), event.startDate);
          } catch (Throwable e) {
            e.printStackTrace();
          }
        });
  ...
  public void testZonedDateTimeEvent() {
    doInJPA(
        entityManager -> {
          ...
          event.id = 1L;
          event.startDate =
              ZonedDateTime.of(2017, 6, 24, 15, 45, 23, 0, ZoneOffset.systemDefault());
          entityManager.persist(event);
        });
