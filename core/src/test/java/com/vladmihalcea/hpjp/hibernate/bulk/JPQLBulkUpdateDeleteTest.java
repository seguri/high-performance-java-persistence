  ...
  public int deletePostSpam(EntityManager entityManager) {
    int deleteCount =
        entityManager
            ...
            """)
            .setParameter("status", PostStatus.SPAM)
            .setParameter("validityThreshold", Timestamp.valueOf(LocalDateTime.now().minusDays(7)))
            .executeUpdate();
  ...
  public int deletePostCommentSpam(EntityManager entityManager) {
    int deleteCount =
        entityManager
            ...
            """)
            .setParameter("status", PostStatus.SPAM)
            .setParameter("validityThreshold", Timestamp.valueOf(LocalDateTime.now().minusDays(3)))
            .executeUpdate();
