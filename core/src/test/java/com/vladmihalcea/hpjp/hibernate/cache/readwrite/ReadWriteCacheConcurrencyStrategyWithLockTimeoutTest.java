...
/**
 * ReadWriteCacheConcurrencyStrategyWithTimeoutTest - Test to check
 * CacheConcurrencyStrategy.READ_WRITE with lock timeout
 *
 * @author Vlad Mihalcea
 */
public class ReadWriteCacheConcurrencyStrategyWithLockTimeoutTest
