  ...
  protected void afterInit() {
    doInJPA(
        entityManager -> {
          ...
          post.addComment(new PostComment().setId(1L).setReview("A must-read!"));

          post.addComment(new PostComment().setId(2L).setReview("Awesome!"));

          post.addComment(new PostComment().setId(3L).setReview("5 stars"));
  ...
  public void testEntityProxyWithoutSecondLevelCache() {
    ...
    doInJPA(
        entityManager -> {
          ...
          assertEquals("A must-read!", comment.getReview());
