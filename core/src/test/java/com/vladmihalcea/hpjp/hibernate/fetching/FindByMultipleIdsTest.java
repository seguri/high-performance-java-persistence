          ...
          List<Book> books =
              entityManager
                ...
                """,
                      Book.class)
                  .setParameter(
                      "isbn", Arrays.asList("978-9730228236", "978-1934356555", "978-3950307825"))
                  .getResultList();
        ...
        entityManager -> {
          ...
          List<Book> books =
              session
                  ...
                  .multiLoad("978-9730228236", "978-1934356555", "978-3950307825");
    ...
    doInJPA(
        entityManager -> {
          ...
          List<Book> books =
              session
                  .byMultipleIds(Book.class)
                  .multiLoad(List.of("978-9730228236", "978-1934356555", "978-3950307825"));
