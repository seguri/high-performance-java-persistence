...
public class DateTruncUtcFunctionTest extends AbstractPostgreSQLIntegrationTest {
  ...
  public static class SqlFunctionsMetadataBuilderContributor implements MetadataBuilderContributor {

    @Override
    public void contribute(MetadataBuilder metadataBuilder) {
      metadataBuilder.applySqlFunction("date_trunc", DateTruncFunction.INSTANCE);
    }
    ...
    public static class DateTruncFunction extends NamedSqmFunctionDescriptor {
      ...
      public DateTruncFunction() {
        super("date_trunc", false, StandardArgumentsValidators.exactly(1), null);
      }
  ...
  public void test() {
    doInJPA(
        entityManager -> {
          ...
          assertEquals(
              Timestamp.valueOf(LocalDateTime.of(2018, 11, 23, 0, 0, 0)),
