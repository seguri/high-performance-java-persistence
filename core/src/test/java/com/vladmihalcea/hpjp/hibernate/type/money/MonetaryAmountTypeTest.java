...
public class MonetaryAmountTypeTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class[] {Product.class, ProductPricing.class};
  }
              ...
              new Product()
                  ...
                  .addPricingPlan(
                      new ProductPricing()
                          ...
                          .setPrice(Money.of(new BigDecimal("49.0"), "USD")))
                  .addPricingPlan(
                      new ProductPricing()
                          .setName("5-Year Individual License")
                          .setType(PricingType.ONE_TIME_PURCHASE)
                          .setPrice(Money.of(new BigDecimal("199.0"), "USD")))
                  .addPricingPlan(
                      new ProductPricing()
                          .setName("10-Dev Group License")
                          .setType(PricingType.SUBSCRIPTION)
                          .setPrice(Money.of(new BigDecimal("349.0"), "USD"))));
        });
  ...
  public static class ProductPricing {
    ...
    @Enumerated private PricingType type;

    @Columns(columns = {@Column(name = "price_amount"), @Column(name = "price_currency")})
