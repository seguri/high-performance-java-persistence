...
public class AttributeConverterMonthDayTest extends AbstractTest {
  ...
  protected Class<?>[] entities() {
    return new Class<?>[] {AnnualSubscription.class};
  }
        ...
        entityManager -> {
          entityManager.persist(
              new AnnualSubscription()
                  .setId(1L)
                  .setPriceInCents(700)
                  .setPaymentDay(MonthDay.of(Month.AUGUST, 17)));
        });
  ...
  public void testNull() {
    doInJPA(
        entityManager -> {
          entityManager.persist(
              new AnnualSubscription().setId(1L).setPriceInCents(700).setPaymentDay(null));
        });
