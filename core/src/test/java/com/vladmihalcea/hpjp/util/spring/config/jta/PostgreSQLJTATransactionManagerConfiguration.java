...
@Configuration
public abstract class PostgreSQLJTATransactionManagerConfiguration
    extends AbstractJTATransactionManagerConfiguration {
  ...
  public DataSource actualDataSource() {
    ...
    dataSource.setUrl(
        String.format("jdbc:postgresql://%s:%s/%s", jdbcHost, jdbcPort, jdbcDatabase));
