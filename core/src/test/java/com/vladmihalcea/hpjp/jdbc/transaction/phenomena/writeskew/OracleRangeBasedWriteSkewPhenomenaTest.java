 ...
 */
public class OracleRangeBasedWriteSkewPhenomenaTest
      ...
      try {
        doInJDBC(
            aliceConnection -> {
              ...
              update(
                  aliceConnection,
                  "UPDATE employee SET salary = salary * 1.1 WHERE department_id = 1 and id < 4");
            });
      } catch (Exception e) {
        LOGGER.info("Exception thrown", e);
        preventedByLocking.set(true);
          ...
          aliceConnection -> {
            ...
            if (99_000 != salaryCount) {
              ...
              LOGGER.info(
                  ...
                  isolationLevelName,
                  preventedByLocking.get() ? "due to locking" : "");
              ok.incrementAndGet();
            }
          });
