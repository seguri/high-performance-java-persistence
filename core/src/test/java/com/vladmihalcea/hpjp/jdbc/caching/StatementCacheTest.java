...
public class StatementCacheTest extends DatabaseProviderIntegrationTest {
  ...
  public static Collection<DataSourceProvider[]> rdbmsDataSourceProvider() {
    ...
    providers.add(
        new DataSourceProvider[] {
          new MySQLDataSourceProvider().setUseServerPrepStmts(false).setCachePrepStmts(false)
        });

    providers.add(
        new DataSourceProvider[] {
          new MySQLDataSourceProvider().setUseServerPrepStmts(true).setCachePrepStmts(false)
        });
  ...
  public void testMySQLStatementCaching() {
    ...
    LOGGER.info(
        "When using {}, throughput is {} statements", dataSourceProvider(), queryCount.get());
    logReporter.report();
  }
  ...
  public void testStatementCaching2() {
    ...
    LOGGER.info(
        "When using {}, throughput is {} statements per minute",
        dataSourceProvider(),
        counterHolder.get());
  }
