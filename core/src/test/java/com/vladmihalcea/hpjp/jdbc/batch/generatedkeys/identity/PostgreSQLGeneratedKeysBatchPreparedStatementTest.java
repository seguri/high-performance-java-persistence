...
/**
 * GeneratedKeysBatchPreparedStatementTest - Base class for testing JDBC PreparedStatement generated
 * keys
 *
 * @author Vlad Mihalcea
 */
public class PostgreSQLGeneratedKeysBatchPreparedStatementTest
  ...
  protected void batchInsert(Connection connection) throws SQLException {
    ...
    try (PreparedStatement postStatement =
        connection.prepareStatement(
            "insert into post (title, version) values (?, ?)", Statement.RETURN_GENERATED_KEYS)) {
