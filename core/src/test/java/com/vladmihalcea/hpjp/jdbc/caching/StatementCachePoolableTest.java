...
public class StatementCachePoolableTest extends DataSourceProviderIntegrationTest {
  ...
  public static class CachingOracleDataSourceProvider extends OracleDataSourceProvider {
    ...
    public DataSource dataSource() {
      ...
      try {
        ...
        connectionProperties.put(
            "oracle.jdbc.implicitStatementCacheSize", Integer.toString(cacheSize));
    ...
    public String toString() {
      return "CachingOracleDataSourceProvider{" + "cacheSize=" + cacheSize + '}';
    }
  }
  ...
  public static class CachingSQLServerDataSourceProvider extends SQLServerDataSourceProvider {
    ...
    @Override
    public String toString() {
      return "CachingSQLServerDataSourceProvider{" + "cacheSize=" + cacheSize + '}';
    }
  }
  ...
  public static class CachingPostgreSQLDataSourceProvider extends PostgreSQLDataSourceProvider {
    ...
    @Override
    public String toString() {
      return "CachingPostgreSQLDataSourceProvider{" + "cacheSize=" + cacheSize + '}';
    }
  }
  ...
  public static Collection<DataSourceProvider[]> rdbmsDataSourceProvider() {
    ...
    providers.add(new DataSourceProvider[] {new CachingOracleDataSourceProvider(1)});
    providers.add(new DataSourceProvider[] {new CachingSQLServerDataSourceProvider(1)});
    providers.add(new DataSourceProvider[] {new CachingPostgreSQLDataSourceProvider(1)});
    ...
    providers.add(new DataSourceProvider[] {mySQLCachingDataSourceProvider});
    return providers;
  }
  ...
  public void selectWhenCaching() {
    ...
    LOGGER.info("When using {}, throughput is {} statements", dataSourceProvider(), counter.get());
  }
