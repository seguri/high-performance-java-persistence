 ...
 */
public class PostgreSQLRangeBasedWriteSkewPhenomenaConstraintTest
    ...
    doInJDBC(
        aliceConnection -> {
          ...
          if (99_000 != salaryCount) {
            LOGGER.info(
                "Isolation level {} allows overbudgeting since the salary count is {} instead of 99000",
                isolationLevelName,
                salaryCount);
          } else {
            LOGGER.info(
                ...
                preventedByLocking.get()
                    ...
                    : preventedByMVCC.get()
                        ? "MVCC"
                        : preventedByConstraint.get() ? "check constraint" : "unknown");
          }
        });
  }
