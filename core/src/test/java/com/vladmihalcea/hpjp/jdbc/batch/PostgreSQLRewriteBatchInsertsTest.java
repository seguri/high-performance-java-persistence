...
/**
 * PostgreSQLRewriteBatchInsertsTest - Test PostgreSQL JDBC Statement batching with and w/o
...
public class PostgreSQLRewriteBatchInsertsTest extends AbstractPostgreSQLIntegrationTest {
  ...
  public void testInsert() {
    ...
    LOGGER.info(
        "Test PostgreSQL batch insert with reWriteBatchedInserts={}", reWriteBatchedInserts);
    logReporter.report();
    LOGGER.info(
