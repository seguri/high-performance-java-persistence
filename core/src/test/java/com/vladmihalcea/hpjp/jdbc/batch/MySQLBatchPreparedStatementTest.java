...
/**
 * MySqlBatchStatementTest - Test MySQl JDBC Statement batching with and w/o
...
public class MySQLBatchPreparedStatementTest extends AbstractMySQLIntegrationTest {
  ...
  protected DataSourceProvider dataSourceProvider() {
    MySQLDataSourceProvider dataSourceProvider =
        (MySQLDataSourceProvider) super.dataSourceProvider();
  ...
  public void testInsert() {
    ...
    LOGGER.info(
        "Test MySQL batch insert with cachePrepStmts={}, useServerPrepStmts={}",
        cachePrepStmts,
        useServerPrepStmts);
    ...
    LOGGER.info(
        "{}.testInsert for cachePrepStmts={}, useServerPrepStmts={} took {} millis",
